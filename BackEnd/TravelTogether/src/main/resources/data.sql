...
(1, 1, '해운대해수욕장', 1, 1, 35.1586, 129.1604, 1, 10500),
(2, 1, '광안리해수욕장', 1, 2, 35.1531, 129.1182, 1, 11000),
(3, 1, '더베이 101', 1, 3, 35.1560, 129.1486, 1, 11500),
(4, 1, '부산타워', 1, 4, 35.1011, 129.0317, 1, 12000),

-- 2일차 (day_id = 2) -> 범위: 20000-29999
(5, 2, '감천문화마을', 1, 1, 35.0970, 129.0107, 1, 20500),
(6, 2, '국제시장', 1, 2, 35.1298, 129.0297, 1, 21000),
(7, 2, '자갈치시장', 1, 3, 35.0967, 129.0304, 1, 21500),
(8, 2, '부산영화체험박물관', 1, 4, 35.0951, 129.0283, 1, 22000),

-- 제주 여행 (trip_id = 2)
-- 1일차 (day_id = 4) -> 범위: 40000-49999
(9, 4, '제주공항', 2, 1, 33.5067, 126.4930, 1, 40500),
(10, 4, '성산일출봉', 2, 2, 33.4587, 126.9426, 1, 41000),

-- 2일차 (day_id = 5) -> 범위: 50000-59999
(11, 5, '한라산', 2, 1, 33.3616, 126.5292, 1, 50500),

-- 3일차 (day_id = 6) -> 범위: 60000-69999
(12, 6, '만장굴', 2, 1, 33.5284, 126.7714, 1, 60500),
(13, 6, '세화해변', 2, 2, 33.5252, 126.8589, 1, 61000),
(14, 6, '비자림', 2, 3, 33.4894, 126.8090, 1, 61500),

-- 4일차 (day_id = 7) -> 범위: 70000-79999
(15, 7, '협재해수욕장', 2, 1, 33.3940, 126.2392, 1, 70500),
(16, 7, '제주공항', 2, 2, 33.5067, 126.4930, 1, 71000);
-- Routes
