...
-- 제주 여행 (trip_id = 2)
-- 1일차
(9, 1, '제주공항', 2, 1, 33.5067, 126.4930, 1, 1000),
(10, 1, '성산일출봉', 2, 2, 33.4587, 126.9426, 1, 1500),

-- 2일차
(11, 2, '한라산', 2, 1, 33.3616, 126.5292, 1, 2000),

-- 3일차
(12, 3, '만장굴', 2, 1, 33.5284, 126.7714, 1, 3000),
(13, 3, '세화해변', 2, 2, 33.5252, 126.8589, 1, 3333),
(14, 3, '비자림', 2, 3, 33.4894, 126.8090, 1, 3666),

-- 4일차
(15, 4, '협재해수욕장', 2, 1, 33.3940, 126.2392, 1, 4000),
(16, 4, '제주공항', 2, 2, 33.5067, 126.4930, 1, 4500);
-- Routes
